...
abstract class InboundPacket extends Packet {
	...
	const QUERY_ENTITY_NBT_PACKET = 0x0d;
	...
	const EDIT_BOOK_PACKET = 0x0c;
	const INTERACT_ENTITY_PACKET = 0x0e;
	const GENERATE_STRUCTURE_PACKET = 0x0f;
	const KEEP_ALIVE_PACKET = 0x10;
	const LOCK_DIFFICULTY_PACKET = 0x11;
	...
	const VEHICLE_MOVE_PACKET = 0x16;
	const STEER_BOAT_PACKET = 0x17;
	const PICK_ITEM_PACKET = 0x18;
	...
	const STEER_VEHICLE_PACKET = 0x1d;
	...
	const UPDATE_COMMAND_BLOCK_MINECART_PACKET = 0x27;
	const CREATIVE_INVENTORY_ACTION_PACKET = 0x28;
	const UPDATE_JIGSAW_BLOCK_PACKET = 0x29;
	...
	const PLAYER_BLOCK_PLACEMENT = 0x2e;
