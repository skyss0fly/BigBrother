...
abstract class OutboundPacket extends Packet{
	...
	/**
	 * Packets taken from:
	 * {@link https://wiki.vg/index.php?title=Protocol&oldid=16317}
	 */
	...
	const ACKNOWLEDGE_PLAYER_DIGGING_PACKET = 0x07;
	...
	const SET_COOLDOWN_PACKET = 0x16;
	...
	const OPEN_HORSE_WINDOW_PACKET = 0x1e;
	...
	const TRADE_LIST_PACKET = 0x26;
	const ENTITY_POSITION_PACKET = 0x27;
	const ENTITY_POSITION_AND_ROTATION_PACKET = 0x28;
	const ENTITY_ROTATION_PACKET = 0x29;
	const ENTITY_MOVEMENT_PACKET = 0x2a;
	const VEHICLE_MOVE_PACKET = 0x2b;
	const OPEN_BOOK_PACKET = 0x2c;
	...
	const COMBAT_EVENT_PACKET = 0x31;
	const PLAYER_LIST_PACKET = 0x32;
	const FACE_PLAYER_PACKET = 0x33;
	...
	const RESOURCE_PACK_SEND_PACKET = 0x38;
	const RESPAWN_PACKET = 0x39;
	const ENTITY_HEAD_LOOK_PACKET = 0x3a;
	const MULTI_BLOCK_CHANGE_PACKET = 0x3b;
	const SELECT_ADVANCEMENT_TAB_PACKET = 0x3c;
	const WORLD_BORDER_PACKET = 0x3d;
	const CAMERA_PACKET = 0x3e;
	...
	const ATTACH_ENTITY_PACKET = 0x45;
	...
	const SET_PASSENGERS_PACKET = 0x4b;
	const TEAMS_PACKET = 0x4c;
	const UPDATE_SCORE_PACKET = 0x4d;
	const TIME_UPDATE_PACKET = 0x4e;
	const TITLE_PACKET = 0x4f;
	const ENTITY_SOUND_EFFECT_PACKET = 0x50;
	const SOUND_EFFECT_PACKET = 0x51;
	const STOP_SOUND_PACKET = 0x52;
	const PLAYER_LIST_HEADER_AND_FOOTER_PACKET = 0x53;
	const NBT_QUERY_RESPONSE = 0x54;
	...
	const DECLARE_RECIPES_PACKET = 0x5a;
